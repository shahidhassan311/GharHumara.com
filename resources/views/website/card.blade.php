            ...
            <div class="container gal-container">
                <div class="col-md-3">
                    <div class="col-xs-12" style="padding: 20px 0;background-color: #f7f2df; border-bottom: 3px solid #d3af35;">
                        <h6 style="text-align: center;color: #d3af35;margin: 10px 0px"><b>Wedding Cards</b></h6>
                    </div>
                    <div class="col-xs-12" style="padding: 20px 5px;background-color: #f7f2df;">
                        <p style="text-align: justify;margin: 10px"><b>Wedding invitation card design is one of the most creative areas of print design today. WedDecore's talented designers really pull out all the stops and create some amazingly inspirational pieces. You can view our card gallery to get a gist of what our designers are capable of. Feel free to take inspiration from these samples and get them customised to your taste.</b></p>
                    </div>
                    ...
                    <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#1">
                                <img src="/public/website/images/cards/1.jpg">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#2">
                                <img src="/public/website/images/cards/2.jpg">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#3">
                                <img src="/public/website/images/cards/3.jpg">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#4">
                                <img src="/public/website/images/cards/4.jpg">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#5">
                                <img src="/public/website/images/cards/5.jpg">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#6">
                                <img src="/public/website/images/cards/6.jpg">
                            </a>
                    ...
                    <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#7">
                                <img src="/public/website/images/cards/7.jpg">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#8">
                                <img src="/public/website/images/cards/8.jpg">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#9">
                                <img src="/public/website/images/cards/9.jpg">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#10">
                                <img src="/public/website/images/cards/10.jpg">
                            </a>
                    ...
                    <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#11">
                                <img src="/public/website/images/cards/11.jpg">
                            </a>
                    ...
                    <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                        <div class="box">
                            <a href="#" data-toggle="modal" data-target="#12">
                                <img src="/public/website/images/cards/12.jpg">
                            </a>
