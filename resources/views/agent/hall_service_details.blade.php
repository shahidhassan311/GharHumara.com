                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active p-3" id="home-tab-pane" role="tabpanel"
                            ...
                            <div class="widget-group row no-gutters">
                                ...
                                <!-- WIDGET 1 -->
                                @foreach ($hall_service_images as $key => $hall_service_image)
                                    @if($hall_service_image->images !== '')
                                        <img src="{{ URL::to('/') }}/uploads/{{ $hall_service_image->images }}" style="height: 300px; width: 250px" alt="">
                                    @else
                                ...
                                @foreach ($hall_services as $key => $hall_service)
                                    <p>{{ $hall_service->service_name }}</p><br>
