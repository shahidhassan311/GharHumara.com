    ...
    <div class="content custom-scrollbar">
        ...
        <div class="doc data-table-doc page-layout simple full-width">
            ...
            <div class="page-header bg-secondary text-auto p-6 row no-gutters align-items-center justify-content-between">
                ...
                <a href="/add_booking" class="btn btn-light fuse-ripple-ready">
                                            ...
                                            <table id="sample-data-table" class="table">
                                                ...
                                                @foreach ($booking as $key => $bookings)
                                                    <tr>
                                                        ...
                                                        <td>{{ $bookings->hall_name }}</td>
                                                        <td>{{ $bookings->section_name }}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu" x-placement="top-start" x-out-of-boundaries="" style="position: absolute; transform: translate3d(0px, -12px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                    <a class="dropdown-item fuse-ripple-ready" href="/booking_edit/{{ $bookings->id }}">EDIT</a>
                                                                    <a class="dropdown-item fuse-ripple-ready" href="/booking_delete/{{ $bookings->id }}">DELETE</a>
                                                                </div>
                                                            </div>
                                                        </td>
