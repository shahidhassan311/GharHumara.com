                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active p-3" id="home-tab-pane" role="tabpanel"
                            ...
                            <div class="widget-group row no-gutters">
                                ...
                                @foreach ($vendor_photography_images as $key => $hall_service_imagess)
                                    
                                    @if($hall_service_imagess->images !== '')
                                        
                                        <img src="{{ URL::to('/') }}/uploads/{{ $hall_service_imagess->images }}" style="right: 200px; height: 200px" alt="">
                                ...
                                @foreach ($vendor_photography as $key => $hall_service)
                                    
                                    <p>{{ $hall_service->name }}</p><br>
                                    <p>{{ $hall_service->service_company }}</p><br>
                                    <p>{{ $hall_service->amount }}</p><br>
                                    <p>{{ $hall_service->details }}</p><br>
                                    @if($hall_service->profile_image !== '')
            
                                        <img src="{{ URL::to('/') }}/uploads/{{ $hall_service->profile_image }}"
                                             style="right: 200px; height: 200px" alt="">
                                    ...
                                    @endif
                                    @if($hall_service->cover_images !== '')
            
                                        <img src="{{ URL::to('/') }}/uploads/{{ $hall_service->cover_images }}"
                                             style="right: 200px; height: 200px" alt="">
