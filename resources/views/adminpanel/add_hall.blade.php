                                    ...
                                    <div class="preview">
                                        <div class="preview-elements">
                                            ...
                                            <form action="{{ ($update) ? url('/hall_update') : url('/add_hall_store') }}" method="post">
                                                {{ csrf_field() }}
                                                <input type="hidden" value="{{($update) ? $hall_section->id : old('hall_section')}}" name="p_id">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    id="exampleFormControlSelect1">
                                                        <option value="pending" {{ ($update) ? $hall_section->status : 'pending' ? 'selected="selected"' : ''}}>Pending</option>
                                                        <option value="approved" {{ ($update) ? $hall_section->status : 'approved' ? 'selected="selected"' : ''}}>Approved</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
