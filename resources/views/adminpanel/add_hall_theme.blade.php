                                ...
                                <div class="source-preview-wrapper">
                                    <div class="preview">
                                        <div class="preview-elements">
                                            ...
                                            <form action="{{($update) ? url('/theme_update') : url('/add_hall_theme_store')}}"
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control"
                                                           ...
                                                           value="{{($update) ? $hall_theme->name : old('name') }}"
                                                ...
                                                @if(($update) ?  $hall_theme_image : old('images'))
                                                    @foreach($hall_theme_image as $hall_theme_images)

                                                        @if(($update) ?  $hall_theme_images->images : old('images'))
                                                        @else
                                                            <div class="form-group">
                                            ...
                                            @if($update == true)
                                            @foreach($hall_theme_image as $hall_theme_images)
                                            @if(($update) ? $hall_theme_images->images !== 'NULL' : old('images'))
                                                <a href="/theme_image_delete/{{($update) ? $hall_theme_images->id : old('id')}}">
                                                    <button class="btn btn-danger">DELETE</button>
                                                </a>
                                                <img src="{{ URL::to('/') }}/uploads/{{ ($update) ? $hall_theme_images->images : old('images')}}" height="200" width="300" alt="">
                                            @else
                                            @endif
                                                @endforeach
                                            @endif
