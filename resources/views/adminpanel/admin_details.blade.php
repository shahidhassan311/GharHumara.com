    ...
    <div class="content custom-scrollbar">
        ...
        <div class="doc data-table-doc page-layout simple full-width">
            ...
            <div class="page-header bg-secondary text-auto p-6 row no-gutters align-items-center justify-content-between">
                <h2 class="doc-title" id="content">Admin</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="example ">
                                ...
                                <div class="source-preview-wrapper" style="    overflow: unset !important;">
                                    <div class="preview">
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu" x-placement="top-start" x-out-of-boundaries="" style="position: absolute; transform: translate3d(0px, -12px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                    <a class="dropdown-item fuse-ripple-ready" href="/admin_hall/{{ $admins->id }}">DETAIL</a>
                                                                    <a class="dropdown-item fuse-ripple-ready" href="#">EDIT</a>
                                                                    <a class="dropdown-item fuse-ripple-ready" href="#">DELETE</a>
                                                                </div>
                                                            </div>
                                                        </td>
