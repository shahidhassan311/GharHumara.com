...
@section('content')
    <div class="content custom-scrollbar">
            ...
            <div class="page-content-wrapper custom-scrollbar">
                ...
                <div class="page-content">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn active" id="home-tab" data-toggle="tab" href="#home-tab-pane"
                               role="tab" aria-controls="home-tab-pane" aria-expanded="true">Home</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link btn" id="budget-summary-tab" data-toggle="tab"
                               href="#budget-summary-tab-pane" role="tab" aria-controls="budget-summary-tab-pane">Budget
                                Summary</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link btn" id="team-members-tab" data-toggle="tab"
                               href="#team-members-tab-pane" role="tab" aria-controls="team-members-tab-pane">Team
                                Members</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="widget widget5 card">
                                        ...
                                        <div class="widget-header px-4 row no-gutters align-items-center justify-content-between">
                                            ...
                                            <div>
                                                ...
                                                <button type="button" class="widget5-option-change-btn btn btn-link"
                                                        data-interval="TW">
                                                    This Week
                                                </button>
                        ...
                        <div class="tab-pane fade p-3" id="budget-summary-tab-pane" role="tabpanel"
                        ...
                        <div class="tab-pane fade p-6" id="team-members-tab-pane" role="tabpanel"
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/james.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/katherine.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/andrew.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/jane.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/alice.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/vincent.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/joyce.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/danielle.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/carl.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/profile.jpg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="avatar"
                                                             src="{{ URL::to('/') }}/adminpanel/images/avatars/garry.jpg">
        ...
        <script type="text/javascript" src="{{ URL::to('/') }}/adminpanel/js/apps/dashboard/project.js"></script>
