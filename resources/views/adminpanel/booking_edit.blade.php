                                ...
                                <div class="source-preview-wrapper">
                                    <div class="preview">
                                        <div class="preview-elements">
                                            ...
                                            <form action="{{url('/booking_update_a',$bookings->id)}}" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="user_id" class="form-control"
                                                        ...
                                                        @foreach ($users as $key => $user)
                                                            <option value="{{ $user->id }}" {{ $bookings->user_id == $user->id ? 'selected="selected"' : '' }}>{{ $user->name }}  ({{ $user->role }})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="id_state"
                                                                id="exampleFormControlSelect1">
                                                            <option value="{{ $bookings->hall_role_type_id }}"{{ $bookings->hall_role_type_id == $bookings->hall_role_type_id ? 'selected="selected"' : '' }}>{{$bookings->section_name}}</option>
