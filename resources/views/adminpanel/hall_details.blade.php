                ...
                <div class="page-header bg-secondary text-auto d-flex flex-column justify-content-between px-6 pt-4 pb-0">
                    ...
                    <div class="row no-gutters align-items-start justify-content-between flex-nowrap">
                        ...
                        <div>
                            ...
                            <span class="h2">Welcome to <strong>{{ $halls->hall_name }}</strong>      Venue <b>(Hall #{{ $halls->hall_id }})</b></span>
                                @endforeach
                        </div>
                            ...
                            <div class="widget-group row no-gutters">
                                ...
                                @foreach ($hall_details as $key => $hall_detail)
                                    ...
                                    <div class="col-12 col-sm-6 col-xl-3" style="padding: 5px;border: 1px solid black;">
                                        <a href="/hall_section_details/{{ $hall_detail->section_id }}" style="text-decoration: none;">
                                        {{--<div class="widget widget1 card" style="background: url(../uploads/18708.png);    background-size: contain;">--}}
                                        <div class="widget widget1 card" style="background-repeat: no-repeat;background-size: cover;background: url('<?= (isset($hall_detail->images))?asset('uploads').'/' . $hall_detail->images: asset('placeholder.png') ?>');    background-size: contain;">
                                            ...
                                            <div class="widget-content pt-2 pb-8 d-flex flex-column align-items-center justify-content-center">
                                                <div class="title text-secondary">{{ $hall_detail->section_name }}</div>
                                        ...
                                        <a href="/hall_section_edit_get/{{ $hall_detail->section_id }}"><button class="btn btn-primary">EDIT</button></a>
                                        <a href="/hall_section_delete/{{ $hall_detail->section_id }}"><button class="btn btn-danger">DELETE</button></a>
                                        </div>
                                        </div>
                            ...
                            <div class="widget-group row no-gutters">
                                ...
                                @foreach ($hall_service as $key => $hall_services)
                                    ...
                                    <div class="col-12 col-sm-6 col-xl-3 p-3" style="border: 1px solid;">
                                        <a href="/hall_service_details/{{ $hall_services->id }}" style="text-decoration: none;">
                                            <div class="widget widget1 card" style="background-repeat: no-repeat;background-size: cover;background: url('<?= (isset($hall_services->images))?asset('uploads').'/' . $hall_services->images: asset('placeholder.png') ?>');    background-size: contain;">
                                        ...
                                        <div class="detailbtns" style="text-align: center;padding: 20px;">
                                            <a href="/service_edit/{{ $hall_services->id }}"><button class="btn btn-primary">EDIT</button></a>
                                            <a href="/hall_service_delete/{{ $hall_services->id }}"><button class="btn btn-danger">DELETE</button></a>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade show active p-3" id="home-tab-pane" role="tabpanel"
                            ...
                            <div class="widget-group row no-gutters">
                                ...
                                @foreach ($hall_theme as $key => $hall_themes)
                                    ...
                                    <div class="col-12 col-sm-6 col-xl-3 p-3" style="border: 1px solid;">
                                        <a href="/hall_theme_details/{{ $hall_themes->id }}" style="text-decoration: none;">
                                            <div class="widget widget1 card" style="background-repeat: no-repeat;background-size: cover;background: url('<?= (isset($hall_themes->images))?asset('uploads').'/' . $hall_themes->images: asset('placeholder.png') ?>');    background-size: contain;">
                                            {{--<div class="widget widget1 card">--}}
                                                <div class="widget-header pl-4 pr-2 row no-gutters align-items-center justify-content-between">
                                                </div>
                                                <div class="widget-content pt-2 pb-8 d-flex flex-column align-items-center justify-content-center">
                                                    <div class="title text-secondary">{{ $hall_themes->amount }}</div>
                                                    <div class="sub-title h6 text-muted" style="    color: #0c0c0c !important;font-size: 29px;font-weight: bold;">{{ $hall_themes->detail }}</div>
                                                </div>

                                            </div>
                                        </a>
                                        <div class="detailbtns" style="text-align: center;padding: 20px;">
                                            <a href="/theme_edit/{{ $hall_themes->id }}"><button class="btn btn-primary">EDIT</button></a>
                                            <a href="/hall_theme_delete/{{ $hall_themes->id }}"><button class="btn btn-danger">DELETE</button></a>
                                        </div>
                                    </div>
